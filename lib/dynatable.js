...
(function($) {
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + "〜" + bounds[1] + "</span> / ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " / ";
      }
      text += recordsQueryCount + " " + collection_name;
      if (recordsQueryCount < recordsTotal) {
        text += " (全" + recordsTotal + "件からフィルタリング)";
      }
    ...
    this.create = function() {
      var $search = $('<input />', {
          ...
          $searchSpan = $('<span></span>', {
            ...
            'class': 'dynatable-search i-filter',
            text: ' '
          }).append($search);
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      ...
      }).append("<span class='dynatable-per-page-label i-list'>" + settings.inputs.perPageText + "</span>").append($select);
    };
      ...
      for (var i = 1; i <= pages; i++) {
        ...
        if (settings.inputs.paginationPrev && i === 1) {
          var $prevLink = $('<a></a>',{
            ...
            'class': pageLinkClass + ' dynatable-page-prev i-prev',
        ...
        if (settings.inputs.paginationNext && i === pages) {
          var $nextLink = $('<a></a>',{
            ...
            'class': pageLinkClass + ' dynatable-page-next i-next',
            'data-dynatable-page': page + 1
          });
