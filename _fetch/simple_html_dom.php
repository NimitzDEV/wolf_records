    ...
    function convert_text($text)
    {
        ...
        if (!empty($sourceCharset) && !empty($targetCharset) && (strcasecmp($sourceCharset, $targetCharset) != 0))
        {
            ...
            else
            {
              ...
              //Detected an illegal character 警告対策？
              //if($sourceCharset === "SHIFT_JIS")
              //{
                //$converted_text = iconv($sourceCharset, $targetCharset.'//TRANSLIT',$text;
              //}
...
class simple_html_dom
{
    ...
    function load_file()
    {
        ...
        //Use of undefined constant FILE assumed 'FILE' 対策
        //if($error !==null && $error['file'] == FILE){
        if($error !==null && $error['file'] == 'FILE'){
            $this->clear();
            return false;
        }
