...
trait TRS_Ivory
{
  ...
  public $SKL_MAFIA = [//マフィア言い換え
    ...
    ,"結社員"=>Data::SKL_MASON
    ,"双子"=>Data::SKL_TELEPATH
    ,"刑事"=>Data::SKL_SEER
    ,"警部"=>Data::SKL_SEERWIN
    ,"情報通"=>Data::SKL_SEERAURA
    ,"警視"=>Data::SKL_SAGE
    ,"ボディガード"=>Data::SKL_HUNTER
    ,"検死官"=>Data::SKL_MEDIUM
    ,"鑑識"=>Data::SKL_MEDIWIN
    ,"解剖医"=>Data::SKL_PRIEST
    ,"降霊術師"=>Data::SKL_NECRO
